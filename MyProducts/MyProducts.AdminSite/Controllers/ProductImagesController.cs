...
namespace MyProducts.AdminSite.Controllers
{
    public class ProductImagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Description,ImageSource,ProductId,Active,CreatedDateTime,UpdatedDateTime")] ProductImage productImage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description,ImageSource,ProductId,Active,CreatedDateTime,UpdatedDateTime")] ProductImage productImage)
        {
            if (ModelState.IsValid)
            {
